...
### 2b. Pushnotificaties (optioneel)

Als u de maandelijkse herinnering inschakelt, verwerken Apple (iOS) of Google (Android) een notificatietoken op hun servers om de notificatie af te leveren. Dit token bevat geen financiële informatie. U kunt deze toestemming te allen tijde intrekken via de apparaatinstellingen.
...
- Naam, e-mailadres of andere contactgegevens
- Locatiegegevens
...
## 3. Op welke rechtsgrond verwerken wij uw gegevens?
...
Uw financiële gegevens worden bewaard op uw apparaat totdat u:
...
Wij delen uw financiële gegevens **niet** met derden. Wij verkopen geen gegevens.

De volgende partijen verwerken beperkte gegevens als onderdeel van de dienstverlening:
...
Financiële gegevens worden opgeslagen via de beveiligde sandbox-opslag van iOS en Android (AsyncStorage). Wij maken geen gebruik van extra versleuteling bovenop de platformbeveiliging. Wij raden u aan uw apparaat te beveiligen met een pincode, vingerafdruk of gezichtsherkenning.
...
Bij wezenlijke wijzigingen informeren wij u via een melding in de app. De ingangsdatum bovenaan dit document geeft de meest recente versie aan. Voortgezet gebruik na de ingangsdatum geldt als acceptatie van de gewijzigde voorwaarden.
...
*Dit privacybeleid is opgesteld conform de Algemene Verordening Gegevensbescherming (AVG/GDPR, Verordening (EU) 2016/679) en de Uitvoeringswet AVG.*
